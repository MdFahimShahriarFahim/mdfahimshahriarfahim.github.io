...
const sendEmail = (e) =>{
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactProject.value === ''){
        ...
        emailjs.sendForm('service_lwkax86', 'template_141vh9q', '#contact-form')
...
sr.reveal(`.home__info`, {delay: 600, origin: 'bottom', inerval: 100})
...
sr.reveal(`.certification__card`, {delay: 600, origin: 'bottom', inerval: 100})
...
var typed = new Typed(".auto__type", {
    strings: ['Software Engineer', 'UI/UX', 'SQA', 'Student'],
    typeSpeed: 150,
    backSpeed: 150,
    loop: true
})
